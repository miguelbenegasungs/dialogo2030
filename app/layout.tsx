...
export const metadata: Metadata = {
  ...
  description:
    'Ingeniería aplicada a la gestión. Formar profesionales preparados para la industria del futuro. Campaña para Decano del Instituto de Industria.',
  generator: 'v0.app',
  keywords: [
    'Miguel Benegas',
    'IDEI',
  ...
  openGraph: {
    ...
    description:
      'Ingeniería aplicada a la gestión. Formar profesionales preparados para la industria del futuro.',
    type: 'website',
  },
}
